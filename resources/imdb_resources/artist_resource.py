    ...
    class Config:
        schema_extra = {
            "example": {
                ...
                "links": [
                    {
                        "rel": "known_for_titles",
                        "href": "/api/artists/nm0000001/known_for_titles",
                    },
                    {
                        "rel": "primary_professions",
                        "href": "/api/artists/nm0000001/primary_professions",
                    },
...
class ArtistResource(BaseResource):
    ...
    def get_by_key(self, key):
        ...
        if result:
            ...
            tmp["links"] = [
                {
                    "rel": "primaryProfessions",
                    "href": "/api/artists/" + key + "/primaryProfession",
                },
                {
                    "rel": "knownForTitles",
                    "href": "/api/artists/" + key + "/knownForTitles",
                },
    ...
    def get(self, primaryName=None, birthYear=None, deathYear=None):
        ...
        if result:
            ...
            #
                tmp["links"] = [
                {"rel": "primaryProfessions", "href": "/api/artists/" + i['nconst'] + "/primaryProfession"},
                {"rel": "knownForTitles", "href": "/api/artists/" + i['nconst'] + "/knownForTitles"},
                {"rel": "self", "href": "/api/artists/" + i['nconst']}
                ]
            # Create the response model from the dictionary.
                final_result.append(ArtistRsp(**tmp))
    ...
    def post(self, newValues):
        ...
        ds.create(self.database, self.collection, newValues)
        return new_key