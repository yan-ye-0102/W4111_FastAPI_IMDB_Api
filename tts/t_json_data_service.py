...
db_directory = "/Users/lw/Documents/Github Repositories/W4111_FastAPI_IMDB_Api/data"
...
def t_matches_template():
    ...
    t1 = {"last_name": "Ferguson", "friendly": False}
    ...
    t1 = {"last_name": "Ferguson", "friendly": True}
...
def t_matches_retrieve():
    ...
    t1 = {"role": "Professor", "friendly": True, "school": "SEAS"}
    ...
    result = svc.retrieve(
        ...
        collection_file,
        predicate=t1,
        project=["email", "role", "friendly", "school"],
    )
...
def t_create():
    ...
    svc = get_svc()
    res = svc.create(db_directory, collection_file, new_obj)
    res1 = svc.create(db_directory, collection_file, new_obj_2)
...
def t_delete():
    ...
    Test the create method.
    """
    predicate = {"last_name": "Ferguson", "school": "SEAS"}
    svc = get_svc()

    res = svc.delete(db_directory, collection_file, predicate)
...
def t_update():
    predicate = {"last_name": "Ferguson", "school": "SEAS"}
    new_value = {"friendly": True, "school": "CC"}

    svc = get_svc()

    res = svc.update(db_directory, collection_file, predicate, new_value)
